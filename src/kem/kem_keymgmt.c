...
/* ---------- GEN ---------- */
/* MUST return a genctx pointer. We just pass through provctx. */
static void *kem_gen_init(void *vprovctx, int sel, const OSSL_PARAM p[]) {
    (void)sel; (void)p;
    return vprovctx; /* genctx = provctx */
}

static void *kem_gen_do(void *vprovctx, const char *alg) {
    KM_KEM_KEY *out = kem_new_common(vprovctx, alg);
    if (!out) return NULL;
    ...
    if (OQS_KEM_keypair(out->kem, out->pub, out->priv) != OQS_SUCCESS) {
        kem_free(out);
        return NULL;
    }
    return out;
...
static void *kem_gen_512(void *vprovctx, OSSL_CALLBACK *cb, void *cbarg) {
    (void)cb; (void)cbarg; return kem_gen_do(vprovctx, "MLKEM512");
}
static void *kem_gen_768(void *vprovctx, OSSL_CALLBACK *cb, void *cbarg) {
    (void)cb; (void)cbarg; return kem_gen_do(vprovctx, "MLKEM768");
}
static void *kem_gen_1024(void *vprovctx, OSSL_CALLBACK *cb, void *cbarg) {
    (void)cb; (void)cbarg; return kem_gen_do(vprovctx, "MLKEM1024");
}
...
static const OSSL_PARAM *kem_imexport_types(int selector) {
    ...
    if (selector & OSSL_KEYMGMT_SELECT_PRIVATE_KEY) return priv;
    return pub;
}
...
/* ---------- QUERY_OPERATION_NAME (helps listing & clarity) ---------- */
static const char *kem_qop_name_512 (int op) { return (op == OSSL_OP_KEM) ? "MLKEM512"  : NULL; }
static const char *kem_qop_name_768 (int op) { return (op == OSSL_OP_KEM) ? "MLKEM768"  : NULL; }
static const char *kem_qop_name_1024(int op) { return (op == OSSL_OP_KEM) ? "MLKEM1024" : NULL; }
...
const OSSL_DISPATCH km_kem_keymgmt_fns_mlkem512[] = {
    ...
    { OSSL_FUNC_KEYMGMT_GETTABLE_PARAMS,       (void (*)(void))kem_gettable_params },
    ...
    { OSSL_FUNC_KEYMGMT_GEN,                   (void (*)(void))kem_gen_512 },
    { OSSL_FUNC_KEYMGMT_GEN_CLEANUP,           (void (*)(void))kem_gen_cleanup },
    { OSSL_FUNC_KEYMGMT_QUERY_OPERATION_NAME,  (void (*)(void))kem_qop_name_512 },
    { 0, NULL }
};
...
const OSSL_DISPATCH km_kem_keymgmt_fns_mlkem768[]  = {
    ...
    { OSSL_FUNC_KEYMGMT_EXPORT_TYPES,          (void (*)(void))kem_imexport_types },
    { OSSL_FUNC_KEYMGMT_GEN_INIT,              (void (*)(void))kem_gen_init },
    { OSSL_FUNC_KEYMGMT_GEN,                   (void (*)(void))kem_gen_768 },
    { OSSL_FUNC_KEYMGMT_GEN_CLEANUP,           (void (*)(void))kem_gen_cleanup },
    { OSSL_FUNC_KEYMGMT_QUERY_OPERATION_NAME,  (void (*)(void))kem_qop_name_768 },
    { 0, NULL }
};
...
const OSSL_DISPATCH km_kem_keymgmt_fns_mlkem1024[] = {
    ...
    { OSSL_FUNC_KEYMGMT_EXPORT_TYPES,          (void (*)(void))kem_imexport_types },
    { OSSL_FUNC_KEYMGMT_GEN_INIT,              (void (*)(void))kem_gen_init },
    { OSSL_FUNC_KEYMGMT_GEN,                   (void (*)(void))kem_gen_1024 },
    { OSSL_FUNC_KEYMGMT_GEN_CLEANUP,           (void (*)(void))kem_gen_cleanup },
    { OSSL_FUNC_KEYMGMT_QUERY_OPERATION_NAME,  (void (*)(void))kem_qop_name_1024 },
    { 0, NULL }
};
